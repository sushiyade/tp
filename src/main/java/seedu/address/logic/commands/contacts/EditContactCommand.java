...
public class EditContactCommand extends Command {
    ...
    public static final String MESSAGE_USAGE = COMMAND_WORD + ": Edits the details of the person identified "
            ...
            + "[" + PREFIX_TELEGRAM_NAME + "TELEGRAM_NAME] \n"
    ...
    private static Person createEditedPerson(Person personToEdit, EditPersonDescriptor editPersonDescriptor) {
        ...
        TelegramName updatedTelegramName = editPersonDescriptor.getTelegramName()
                .orElse(personToEdit.getTelegramName());


        return new Person(updatedName, updatedPhone, updatedEmail, updatedAddress, updatedCompany, updatedTelegramName);
    }
    ...
    public static class EditPersonDescriptor {
        ...
        public EditPersonDescriptor(EditPersonDescriptor toCopy) {
            ...
            setTelegramName(toCopy.telegramName);
        }
        ...
        public boolean isAnyFieldEdited() {
            return CollectionUtil.isAnyNonNull(name, phone, email, address, company, telegramName);
        }
        ...
        public void setTelegramName(TelegramName telegramName) {
            this.telegramName = telegramName;
        }

        public Optional<TelegramName> getTelegramName() {
            return Optional.ofNullable(telegramName);
        }
        ...
        public boolean equals(Object other) {
            ...
            return Objects.equals(name, otherEditPersonDescriptor.name)
                    ...
                    && Objects.equals(telegramName, otherEditPersonDescriptor.telegramName);
        }
